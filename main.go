...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier * r.meanSpeed() /*средняя_скорость_в_км/ч*/ + CaloriesMeanSpeedShift) 	* r.Weight/*вес_спортсмена_в_кг*/ / MInKm * r.Duration.Hours()/*время_тренировки_в_часах*/ * MinInHours)
}
